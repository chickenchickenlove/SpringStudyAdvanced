...
- (코드) 프록시 객체의 내부 호출 문제 해결 방법 확인(자기 자신 주입, 스프링 컨테이너 활용, Provider 활용, 구조 분리, 메서드 분리)
- (정리) 프록시 객체의 내부 호출 문제해결 정리(https://ojt90902.tistory.com/720)
- (정리, 코드) CGLIB 프록시, JDK 프록시 객체의 한계와 DI 테스트(https://ojt90902.tistory.com/721)
